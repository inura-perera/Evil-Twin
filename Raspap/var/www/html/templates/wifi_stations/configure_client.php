    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div id="evil-twin-alert"></div> <!-- Container to show the scan results dynamically -->
          <div class="row align-items-center">
            <div class="col">
              <h4 class="m-0 text-nowrap"><?php echo _("Access Point"); ?></h4>
            </div>
  
            <div class="col">
              <button type="button" class="btn btn-info float-right js-reload-wifi-stations deep-scan"><?php echo _("Scan");
                                                                                                        #run shell code and do it on background
                                                                                                        //   $output = shell_exec('bash /var/www/html/Evil-Twin-Detector/wifi_captuer.sh > /dev/null 2>&1 &');  {% endcomment %}
                                                                                                        ?></button>
            </div>
          </div>
